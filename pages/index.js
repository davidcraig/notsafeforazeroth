...
export default function Home(props) {
  return <PageWithWidgets className={props.className}>
    <Card title='&lt;Not Safe for Azeroth&gt;' className='widget widget-progression'>
      <p className='p-4'>A raiding guild aiming at heroic progression, the name is a play on the phrase "Not Safe for Work" as we are a dark humoured guild so we recruit only players who have a sense of humour and aren't easily offended (aka no snowflakes).</p>
    </Card>
